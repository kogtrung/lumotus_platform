...
export default function CardGridItem({ card, isOwner, onEdit, onDelete }: CardGridItemProps) {
  return (
    <article className="lumo-card lumo-card-hover group relative rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] p-2 transition-all hover:border-[var(--color-primary)]/40">
...
const actionBtnClass =
  'rounded p-1 text-[var(--color-text-muted)] hover:bg-[var(--color-surface-hover)] hover:text-[var(--color-text)]'
