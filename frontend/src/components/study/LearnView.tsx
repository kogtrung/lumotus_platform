...
import { Check, X, ChevronLeft, ChevronRight, Timer } from 'lucide-react'
...
export default function LearnView({
  ...
  const isPartiallyCorrect = userAnswer?.toLowerCase() === normalizedCorrect
        ...
        <div className="rounded-xl border border-[#3D3348] bg-[#252030] p-5">
          ...
          <div className="mb-4 text-center">
            ...
            {currentQ.hint && !isSubmitted && (
              <p className="mt-1 text-sm text-[#8B7A9E]">Hint: {currentQ.hint}</p>
            )}
          </div>
            ...
            {!isSubmitted ? (
              <div className={cn(
                ...
                <input
                  ...
                  autoFocus
                  className="flex-1 bg-transparent text-lg font-bold text-[#F5F0FA] placeholder-[#8B7A9E] outline-none sm:text-xl"
                />
                <button
                  type="button"
                  disabled={!input.trim()}
              ...
              <div className={cn(
                ...
                {!isPartiallyCorrect && (
                  <div className="text-sm">
                    <span className="text-[#8B7A9E]">Correct answer: </span>
                    <span className="font-bold text-[#F5F0FA]">{currentQ.correctAnswer}</span>
                  </div>
                )}
              </div>
            )}
